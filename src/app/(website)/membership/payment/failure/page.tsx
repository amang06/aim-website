  ...
  const retryPayment = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert(`Failed to retry payment: ${errorData.error || "Unknown error"}`);
      }
    } catch (error) {
  ...
  return (
    <div className="min-h-screen">
      <PageHeader
        ...
        description="We couldn't process your payment for the associate membership. This could be due to various reasons like insufficient funds, network issues, or bank restrictions."
        height="small"
      />
