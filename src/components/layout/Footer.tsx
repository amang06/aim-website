  ...
  return (
    <footer className="bg-gray-900 text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 text-sm mb-4">
              Dedicated to promoting and supporting Micro, Small and Medium
              Enterprises across India through advocacy, networking, and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} Association of Indian Manufacturers (AIM). All
              rights reserved.
            </div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 bg-primary-600 hover:bg-primary-700 text-white p-3 rounded-full shadow-lg transition-all duration-200 z-40"
